...
% Gibbs unringing implementation by Jonas Olesen and Sune Jespersen for
% diffusion MRI data based on the algorithm presented by Kellner et al.
%  Magn Reson Med. 2016 Nov;76(5):1574-1581.
%
%
% INPUT:
% image - contains MRI image data. The first dimensions must discriminate
% between pixels, while the last dimension should correspond to
% b-value/ gradient variation. Thus image data could for instance
% be structured as [X,Y,Z,N] or [X,Y,N].
%
...
%
% OUTPUT:
% unrung - contains corrected data with same dimensions as input.
